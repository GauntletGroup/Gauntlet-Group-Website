    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <div className="flex-shrink-0 group">
                <img 
                  src="/Gauntlet Brand White Background.png" 
                  alt="Gauntlet Group" 
                  className="h-12 w-auto transition-all duration-300 group-hover:scale-110 group-hover:drop-shadow-[0_0_20px_rgba(6,182,212,0.5)]"
                />
              </div>
            </div>
              ...
              <div className="ml-10 flex items-baseline space-x-8">
                {['About', 'Services', 'Why Us', 'Contact'].map((item, index) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-cyan-400 to-blue-500 group-hover:w-full transition-all duration-300" />
                  </a>
                ))}
                <a 
                  href="#contact" 
                  className="relative bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-3 rounded-full text-sm font-medium hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/50 group overflow-hidden"
                >
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-blue-900/50 to-cyan-900/50" />
          ...
          {/* Animated lines */}
          <div className="absolute inset-0">
            <div className="absolute top-1/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-cyan-400/50 to-transparent animate-pulse-slow" />
            ...
            <div className="absolute top-3/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-purple-400/50 to-transparent animate-pulse-slow" style={{ animationDelay: '2s' }} />
          </div>
          ...
          <div className="absolute top-1/3 right-1/3 w-16 h-16 bg-gradient-to-br from-cyan-400/20 to-blue-400/20 rounded-full animate-pulse-glow" />
        </div>
        ...
        >
          ...
          <div className="inline-flex items-center bg-gray-800/30 backdrop-blur-sm border border-cyan-500/50 rounded-full px-6 py-3 mb-8 animate-fade-in-up group hover:border-cyan-400 transition-all duration-300">
            <Zap className="text-cyan-400 mr-2 animate-pulse" size={20} />
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight">
            ...
            <br />
            <span className="inline-block animate-slide-in-right bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-gradient-x">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            <a 
              href="#contact" 
              className="group relative inline-flex items-center bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-10 py-5 rounded-full text-lg font-semibold hover:from-cyan-400 hover:to-blue-500 transition-all duration-500 transform hover:scale-110 shadow-2xl hover:shadow-cyan-500/50 overflow-hidden"
            >
            ...
            <a 
              href="#services" 
              className="group inline-flex items-center border-2 border-cyan-400/50 text-cyan-400 px-10 py-5 rounded-full text-lg font-semibold hover:bg-cyan-400/10 hover:border-cyan-400 transition-all duration-500 transform hover:scale-105 relative overflow-hidden"
            >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-cyan-400/50 rounded-full flex justify-center">
            <div className="w-1 h-3 bg-cyan-400 rounded-full mt-2 animate-scroll-indicator" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-flex items-center bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-full px-6 py-3 mb-8 animate-fade-in-up">
              <Globe className="text-cyan-400 mr-2 animate-spin-slow" size={20} />
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              About <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Gauntlet Group</span>
            </h2>
      ...
      <section id="services" className="py-24 bg-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-flex items-center bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-full px-6 py-3 mb-8 animate-fade-in-up">
              <Database className="text-cyan-400 mr-2 animate-pulse" size={20} />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-blue-500/5 translate-y-full group-hover:translate-y-0 transition-transform duration-700" />
                
                <div className={`bg-gradient-to-br from-${service.color}-500/20 to-${service.color === 'cyan' ? 'blue' : service.color === 'emerald' ? 'green' : 'indigo'}-600/20 w-20 h-20 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-all duration-500 relative`}>
      ...
      <section id="why-choose-us" className="py-24 bg-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-flex items-center bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-full px-6 py-3 mb-8 animate-fade-in-up">
              <Cpu className="text-cyan-400 mr-2 animate-spin-slow" size={20} />
              <span className="text-cyan-400 text-sm font-medium">Why Choose Us</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              Why Choose <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Gauntlet Group</span>
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: CheckCircle, title: '100% WEEE Compliant', description: 'Fully compliant processes ensuring your business meets all environmental regulations and standards.', color: 'emerald', delay: '0.2s' },
              ...
              { icon: Users, title: 'Scalable Solutions', description: 'Flexible services that grow with your business, from startups to enterprise-level organizations.', color: 'cyan', delay: '0.6s' },
      ...
      <section id="contact" className="py-24 bg-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-flex items-center bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-full px-6 py-3 mb-8 animate-fade-in-up">
              <Mail className="text-cyan-400 mr-2 animate-pulse" size={20} />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {[
                  ...
                  <div key={field.name} className="group">
                    <label htmlFor={field.name} className="block text-sm font-medium text-gray-300 mb-2 group-focus-within:text-cyan-400 transition-colors duration-300">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-4 bg-gray-800/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-300 group-focus-within:bg-gray-800/70"
                ...
                <div className="group">
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-4 bg-gray-800/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-300 resize-none group-focus-within:bg-gray-800/70"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-4 px-8 rounded-xl font-semibold hover:from-cyan-400 hover:to-blue-500 transition-all duration-500 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900 shadow-lg hover:shadow-cyan-500/50 relative overflow-hidden group"
                >
            ...
            <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
              <div>
                ...
                <div className="space-y-8">
                  {[
                    { icon: Mail, title: 'Email', details: ['info@gauntletgroup.com', 'support@gauntletgroup.com'], color: 'cyan' },
                    { icon: Phone, title: 'Phone', details: ['+1 (555) 123-4567', '+1 (555) 987-6543'], color: 'emerald' },
                    { icon: MapPin, title: 'Office', details: ['123 Tech Plaza, Suite 400', 'Innovation District', 'City, State 12345'], color: 'purple' }
                  ].map((contact, index) => (
                    <div key={index} className="flex items-start space-x-6 group">
                      <div className={`bg-gradient-to-br from-${contact.color}-500/20 to-${contact.color === 'cyan' ? 'blue' : contact.color === 'emerald' ? 'green' : 'indigo'}-600/20 p-4 rounded-xl border border-${contact.color}-500/30 group-hover:scale-110 transition-transform duration-300`}>
              ...
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 group hover:border-cyan-500/50 transition-all duration-500">
                <h4 className="font-bold text-white mb-4 group-hover:text-cyan-400 transition-colors duration-300">
                ...
                <a 
                  href="#contact" 
                  className="inline-flex items-center text-cyan-400 font-semibold hover:text-cyan-300 transition-colors group-hover:translate-x-2 transform duration-300"
                >
                  Book a consultation
      ...
      <footer className="bg-black text-white py-16 relative overflow-hidden border-t border-gray-800/50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-bold mb-6 text-cyan-400">Quick Links</h4>
              <div className="space-y-3">
                {['About Us', 'Services', 'Why Choose Us', 'Contact'].map((link, index) => (
                  <a 
                    key={index}
                    href={`#${link.toLowerCase().replace(' ', '-')}`} 
                    className="block text-gray-400 hover:text-cyan-400 transition-all duration-300 transform hover:translate-x-2"
                  >
                    {link}
                  </a>
                ))}
            ...
            {/* Services */}
            <div>
              <h4 className="font-bold mb-6 text-cyan-400">Services</h4>
              <div className="space-y-3">
