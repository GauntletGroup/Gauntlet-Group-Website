      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl md:text-6xl font-extrabold text-white mb-4 tracking-tight font-display"
          >
            Book a Free{' '}
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-sm text-gray-500 max-w-lg mx-auto mb-8"
          >
          ...
          >
            {[
              { icon: Clock, label: '20 minutes', sub: 'Focused, not a sales pitch.' },
              { icon: Zap, label: 'Same-week', sub: 'Booked within 3–5 days.' },
              { icon: CheckCircle, label: 'Actionable', sub: 'Leave with one recommendation.' },
            ].map((item, i) => (
          ...
          {initFailed && (
            <div className="p-12 text-center flex flex-col items-center justify-center bg-[#0B1120] text-white space-y-6 min-h-[600px]">
              ...
              <p className="text-gray-400 max-w-md text-sm">
                Calendly can't load — usually an adblocker or security extension. Schedule directly:
              </p>
              <a
                href={CALENDLY_URL}
                target="_blank"
