  ...
  return [
    {
      name: 'list_services',
      description:
        'List all services offered by Gauntlet Group with names and short descriptions.',
    ...
    },
    {
      ...
      description:
        'Open the details modal for a specific service on the page so the visitor can read more.',
      inputSchema: {
        type: 'object',
        properties: {
          serviceName: {
    ...
    },
    {
      ...
      description:
        'Scroll the page to a specific section of the Gauntlet Group site.',
      inputSchema: {
        type: 'object',
        properties: {
          section: {
    ...
    },
    {
      name: 'list_sections',
      description:
        'List all sections of the Gauntlet Group site that can be navigated to.',
      inputSchema: { type: 'object', properties: {} },
    ...
    },
    {
      name: 'start_booking',
      description:
        'Scroll to the booking section and optionally pre-fill the Calendly widget with the visitor details.',
      inputSchema: {
        type: 'object',
        properties: {
      ...
      execute: async (args) => {
        ...
        return {
          success: true,
          message: 'Booking section opened with prefill details',
        };
      },
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          automationType: {
            type: 'string',
            description: 'Area to automate (optional)',
          },
          currentTools: {
            type: 'string',
    ...
    },
    {
      ...
      execute: async () => ({
        ...
        description:
          'Gauntlet Group designs and implements AI-powered IT automations for growing businesses.',
        contact: {
...
export function useWebMCP(handlers: WebMCPHandlers) {
  ...
  useEffect(() => {
    ...
    const tools = buildTools(handlersRef.current);
